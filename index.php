  			...
  			<form method="POST" enctype="multipart/form-data">
  				...
  				<table border-spacing="30px;">
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="80" name="a1">
							  <label class="form-check-label">YA</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="a1">
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="100" name="b1">
							  <label class="form-check-label">YA</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="b1">
							  <label class="form-check-label">TIDAK</label>
							</div>
  						</td>
  					</tr>
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="10" name="c1">
							  <label class="form-check-label">YA</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="c1">
							  <label class="form-check-label">TIDAK</label>
							</div>
  						</td>
  					</tr>
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="10" name="d1">
							  <label class="form-check-label">Iya, orang tua memiliki penyakit autoimun</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="2" name="d1">
							  <label class="form-check-label">iya, saudara memiliki penyakit autoimun</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="d1">
							  <label class="form-check-label">TIDAK</label>
							</div>
  						</td>
  					</tr>
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="5" name="e1">
							  <label class="form-check-label">YA</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="e1">
							  <label class="form-check-label">TIDAK</label>
							</div>
  						</td>
  					</tr>
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="5" name="f1">
							  <label class="form-check-label">YA</label>
							</div>

							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" value="0" name="f1">
							  <label class="form-check-label">TIDAK</label>
							</div>
  						</td>
  					</tr>
  					...
  					<tr>
  						<td>
  							<div class="form-check form-check-inline" style="margin-left: 10px;">
							  <input class="form-check-input" type="radio" value="0" name="g1">
							  <label class="form-check-label">YA</label>
							</div>
